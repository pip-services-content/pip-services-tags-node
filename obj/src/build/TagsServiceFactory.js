...
class TagsServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
TagsServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-tags", "factory", "default", "default", "1.0");
TagsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tags", "persistence", "memory", "*", "1.0");
TagsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tags", "persistence", "file", "*", "1.0");
TagsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tags", "persistence", "mongodb", "*", "1.0");
TagsServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tags", "controller", "default", "*", "1.0");
TagsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tags", "service", "seneca", "*", "1.0");
TagsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tags", "service", "http", "*", "1.0");
