...
class PartyTagsV1Schema extends pip_services3_commons_node_1.ObjectSchema {
    constructor() {
        super();
        this.withOptionalProperty('id', pip_services3_commons_node_3.TypeCode.String);
        this.withOptionalProperty('tags', new pip_services3_commons_node_2.ArraySchema(new TagRecordV1Schema_1.TagRecordV1Schema()));
