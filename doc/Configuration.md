...
Example:
```yaml
- descriptor: "pip-services-tags:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
...
Controller persistence has the following configuration properties:
- options: object - Misc configuration options
  - max_tag_count: number - Maximum number of recorded tags (default: 100)
...
Example:
```yaml
- descriptor: "pip-services-tags:service:seneca:default:1.0"
  connection:
    protocol: "http"
    host: "0.0.0.0"
    port: 3000
